...
- Consolidação da KU-FM-002 — Modelo Fundamental da Jornada.
- Consolidação da KU-FM-003 — Quatro Naturezas Fundamentais.
- Inclusão dos diagramas Mermaid oficiais do Modelo Fundamental.
- Criação do Knowledge Board oficial.
- Atualização do roadmap para refletir a conclusão da Parte II.

## 0.1.0 — Consolidação da Parte I — Fundação

- Consolidação da Parte I do Guivos Ecosystem Blueprint.
- Inclusão de essência, propósito, missão operacional, visão de longo prazo, constituição e princípios permanentes.
- Inclusão do ADR-002 sobre a Fundação da Guivos.

## 0.0.1 — Inicialização do GKR

- Criação do repositório oficial de conhecimento da Guivos.
- Definição do Markdown como formato principal.
- Definição do Git como histórico oficial.
- Criação da estrutura inicial do Guivos Ecosystem Blueprint.
