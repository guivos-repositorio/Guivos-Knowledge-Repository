...
PUBLIC HOMES DESIGN SOURCES → CURRENT MAIN / 29 CANONICAL SOURCES
PUBLIC HOMES MASTERS → 8 OF 8 CURRENT / 83 MOVEMENTS
PUBLIC HOMES SNAPSHOT REQUIREMENT → NONE / OPTIONAL EXPORT ONLY
