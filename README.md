...
PUBLIC HOMES DESIGN PRODUCTION RELEASE → GRANTED / EXTERNAL DESIGNER MAY CONSUME GOVERNED PACKAGE
PUBLIC HOMES DESIGN MODE → DESIGNER MANUAL CREATION PRIMARY / AI OPTIONAL / GKR FIGMA CREATION OUT OF SCOPE
