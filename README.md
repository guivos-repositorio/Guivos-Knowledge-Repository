...
O [Roadmap 13.14.0](docs/roadmap.md) governa a sequência da auditoria e dos próximos gates.
...
- [Estado Atual 3.15.0](docs/project/current-state-register.md)
- [Roadmap 13.14.0](docs/roadmap.md)
