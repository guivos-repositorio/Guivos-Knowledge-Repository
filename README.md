...
O/C PRIORITY FLOWS / NAVIGATION → NOT MATERIALIZED / SEPARATE AUTHORIZATION REQUIRED
...
O/C SURFACE MAP + STATE MAP DEFINED ≠ PRIORITY FLOWS ≠ WIREFRAME ≠ UI ≠ IMPLEMENTATION
```
