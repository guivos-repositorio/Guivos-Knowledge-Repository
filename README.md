...
- **Marco vigente:** M7.0.1 — External Outcome Validation Protocol Ready
...
- **BA-STR-002:** checkpoint 0.7.0; COR com 18 candidatos e protocolo de validação externa pronto; nenhum Outcome canônico definido
- **Próximo incremento candidato:** execução governada do External Outcome Validation Protocol, sujeita a aprovação separada
