# LEIA PRIMEIRO — Home Pública — Pessoa

Este diretório contém o contexto isolado de trabalho para a primeira rodada de Design da **Home Pública — Pessoa**.
...
Não adicione documentos específicos de Organizações e Coletivos, Mall, Travel ou Media à mesma execução generativa.
