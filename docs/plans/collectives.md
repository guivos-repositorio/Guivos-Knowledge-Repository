...
- 1 oportunidade gratuita/mês;
- até 2 publicações simultaneamente ativas;
...
- 4 atividades/mês;
- 4 oportunidades/mês;
- até 6 publicações ativas;
- ofertas gratuitas ou pagas;
...
- até 20 publicações ativas;
- ofertas gratuitas, pagas, patrocinadas ou financiadas;
- até 5 núcleos ou programas;
...
- ambiente configurável quando tecnicamente aprovado;
