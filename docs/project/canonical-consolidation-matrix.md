...
Esta matriz controla a revisão das decisões históricas da Guivos.

Os arquivos legados, PDFs e conversas são tratados como evidências. O GKR consolidado permanece como fonte oficial.

## Decisões possíveis

| Decisão | Significado |
|---|---|
| Manter | Conceito permanece sem alteração estrutural |
| Refinar | Conceito permanece, com melhoria de definição ou terminologia |
| Unificar | Conceitos redundantes são consolidados |
| Remover | Conceito deixa de integrar a arquitetura canônica |
| Pendente | Decisão histórica ainda precisa ser recuperada ou validada |

## Fundação

| Conceito | Decisão | Situação |
|---|---|---|
| Essência | Refinar | Remover nomenclaturas arquiteturais antigas sem alterar a formulação central |
| Propósito | Manter | Formulação atual continua válida |
...
| Comando funcional | Refinar | Solicitação de alteração; não representa fato reconhecido |
...
| Conceito | Decisão | Situação |
|---|---|---|
| Pessoa | Manter | Categoria arquitetural oficial |
| Organização | Manter | Categoria arquitetural oficial |
| Coletivo | Manter | Categoria arquitetural oficial para agrupamentos sociais |
...
| Portfólio de possibilidades | Manter | Mantém alternativas futuras sem tratá-las como backlog obrigatório ou competir com movimentos ativos |
| Cartão de Próximo Passo | Manter | Apresenta somente formulação, estado, prioridade relevante, contexto, janela, responsável, prontidão, bloqueio, sensibilidade e ação principal necessária |
| Detalhamento progressivo | Manter | Expõe primeiro o necessário para decisão e controle, preservando informações sensíveis em camadas protegidas |
...
| Agenda de Próximos Passos | Refinar | Apresenta datas, janelas, compromissos, recorrências e revisões sem substituir o calendário geral |
...
| Privacidade visual de Próximos Passos | Manter | Títulos neutros, modo discreto, notificações minimizadas, restrição de busca e proteção em dispositivos compartilhados |
...
| Conceito | Decisão | Situação |
|---|---|---|
| GKR | Manter | Fonte única da verdade |
| GEB | Manter | Artefato arquitetural principal dentro do GKR |
