...
- [Registro do Estado Atual — 2.12.0 e M7.73](current-state-register.md)
...
| índice atual | ativo |
| estado transversal | `GKR-STATE-001` 2.12.0 |
| marco | M7.73 |
| última UXA integrada após merge | UXA-086 |
| próxima UXA | UXA-087, não iniciada |
