...
Fluxo vigente para **nova contratação / novo handoff**:

```text
V5 SNAPSHOT
→ FROZEN / HISTORICAL / REPRODUCIBLE
→ NÃO USAR COMO PACOTE NOVO ENQUANTO O HARDENING V6 ESTIVER ABERTO

V6 DESIGN INPUT HARDENING
→ HUMAN-FIRST
→ DESIGNER-LED
→ AI OPTIONAL
...
→ ACTIVE / UNDER V6 HARDENING

8 PUBLIC HOME MASTERS
→ ACTIVE
...
DESIGN INPUT HARDENING V6
→ GKR-HOMES-DESIGN-INPUT-HARDENING-V6-001
→ REMEDIATION IN PROGRESS

DESIGN PRODUCTION RELEASE
→ GRANTED / GKR-UX-HOMES-DESIGN-PRODUCTION-RELEASE-001 v1.1.0
→ HUMAN-FIRST / TOOL-AGNOSTIC

NEW EXTERNAL DESIGN HANDOFF
