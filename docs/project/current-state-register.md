...
CURRENT FOUNDATION
→ GKR-UX-PERSON-JOURNEY-READ-FIRST-001 v0.1.13
→ GKR-UX-PERSON-JOURNEY-FLOW-001 v0.1.17
...
→ MASTER = GKR-UX-PER104-MASTER-001 v0.1.0 / CURRENT
→ NEXT = PER-105 — SOLICITAÇÃO PENDENTE
→ NOT_STARTED
