...
- execução high-fidelity O/C, autorizada por `GKR-UX-ORGCOL-AUTH-HIFI-AUTH-001 v1.0.0` mas ainda não iniciada;
...
O/C AUTHENTICATED HIGH-FIDELITY EXECUTION
→ AUTHORIZED / NOT_STARTED
