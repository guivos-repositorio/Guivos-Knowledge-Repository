...
→ P1 RESIDUAL REVALIDATION-STATE DRIFT REMEDIATED IN CANDIDATE + MANIFEST
...
NEXT GOVERNED ACT
→ VALIDATE FINAL DOCUMENTARY HEAD OF V8 CANDIDATE
→ THEN DECIDE SEPARATELY WHETHER TO MATERIALIZE V8
