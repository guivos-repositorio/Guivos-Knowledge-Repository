...
```text
PACOTE DOCUMENTAL GOVERNADO
→ DESIGNER RECEBE MASTERS + SOURCE LOCKS + FONTES

DESIGNER
→ CRIA MANUALMENTE
→ PODE USAR IA OPCIONALMENTE

REVISÃO HUMANA
→ VALIDA ADERÊNCIA / DIREÇÃO / ACEITE

GKR
→ NÃO MATERIALIZA FIGMA
```
...
→ PRIMARY MODE / EXTERNAL

AI SUPPORT
→ OPTIONAL / NON-CANONICAL

FINAL DESIGN DELIVERY
→ DESIGNER-OWNED / SUBJECT TO HUMAN REVIEW
