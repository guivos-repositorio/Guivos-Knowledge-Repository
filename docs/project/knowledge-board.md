...
| Estado da capacidade ativa | `In progress — 80%` |
...
| Progresso editorial de Evolução Contínua | `80%` |
| Progresso editorial de Experiências | `100%` |
| Arquitetura funcional | `GLPA-001 1.1.1` |
| Intelligence Architecture | `GIA-000 1.3.0` |
| Glossário | `1.8.0` |
| Documento público | `GOG-001 4.2.1` |
| Foco imediato | Consolidar as integrações funcionais da Capacidade 09 — Evolução Contínua |
...
| 09 — Evolução Contínua | In progress — 80% | Quatro extensões normativas consolidadas; integrações funcionais como próximo bloco |
...
| Evolução Contínua | In progress — 80% |
