...
| A2 — Functional Architecture Discovery | Active — Paused at checkpoint | Descobrir as Core Capabilities permanentes da Guivos |
| GCCM-001 — Guivos Core Capability Model | Discovery | Extrair, testar e validar capacidades a partir do GKR |
...
| A2 — Functional Architecture Discovery | 🟦 Paused at checkpoint |
...
- **Data:** 01/07/2026.
- **Estado:** preparação concluída; execução analítica ainda não iniciada.
- **Ponto de retomada:** análise exclusiva de `Foundation — Essência da Guivos`.
- **Restrição:** não criar ou promover Core Capabilities antes de validação cruzada.
...
| Reference Architecture / GCCM | Discovery |
...
`A2 — Functional Architecture Discovery`, pausada no checkpoint de 01/07/2026.
...
Registro do checkpoint de pausa da A2 e inclusão do Enterprise Economic Model e dos demais temas estratégicos pendentes, realizados em 01/07/2026.
