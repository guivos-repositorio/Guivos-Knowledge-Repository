...
# Matriz de Consolidação Canônica — Adendo da Validação Funcional da Visão Geral da Organização
...
| Responsabilidade principal | criar | uma responsabilidade material recebe prioridade e motivo compreensível |
| Jornadas e compromissos | antecipar | finalidade humana antecede oportunidades e programas |
| Capacidade | contextualizar | recursos e condições são ligados ao compromisso que precisa ser cumprido |
| Movimentos operacionais | subordinar | oportunidades e programas não dominam a superfície inicial |
| Avanço institucional | exigir evidência | mudança, compromisso, período, contribuição e limitações são necessários |
| Ausência de evidência | declarar | nenhum progresso institucional será simulado |
