...
## Organizações e Coletivos — estado corrente

~~~text
JOBS / AUTHORITY → DEFINED
INFORMATION ARCHITECTURE → DEFINED
SURFACE MAP → CANONICAL
STATE MAP → CANONICAL
PRIORITY FLOWS → CANONICAL
NAVIGATION MATERIALIZATION → DEFINED / v1.0.0
LOW-FIDELITY → DELIVERY v0.1.0 + VALIDATION v1.0.0 / PASS
...
| Elemento | Estado |
|---|---|
| Registro do Estado Atual | **3.49.0** |
| Marco funcional | **M7.88** |
| Última UXA funcional numerada | **UXA-101** |
| Próxima UXA | **UXA-102/V5 — NOT_STARTED** |
| O/C Navigation Materialization | **DEFINED / CANONICAL / v1.0.0** |
