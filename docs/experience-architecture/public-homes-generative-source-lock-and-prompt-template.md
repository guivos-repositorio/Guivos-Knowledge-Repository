...
- `GKR-UX-HOME-INTELLIGENCE-HANDOFF-001 v1.1.8` — `docs/experience-architecture/public-home-intelligence-design-handoff.md`;
- `GKR-UX-HOME-INTELLIGENCE-SOURCELOCK-001 v1.1.7` — `docs/experience-architecture/public-home-intelligence-source-lock.md`;
- `GKR-UX-HOME-INTELLIGENCE-MASTER-001 v0.2.6` — `docs/experience-architecture/public-home-intelligence-master-document.md`;
