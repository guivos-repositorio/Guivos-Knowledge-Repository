...
- `GKR-UX-HOME-TRAVEL-MASTER-001 v1.1.0` — `docs/experience-architecture/public-home-travel-master-document.md`;
...
- `GKR-UX-HOME-MEDIA-MASTER-001 v1.1.0` — `docs/experience-architecture/public-home-media-master-document.md`;
...
- `GKR-UX-HOME-ADS-MASTER-001 v1.1.0` — `docs/experience-architecture/public-home-ads-master-document.md`;
