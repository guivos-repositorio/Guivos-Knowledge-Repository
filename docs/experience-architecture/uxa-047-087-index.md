---
id: GKR-UXA-047-087-INDEX-001
title: Índice das Frentes UXA-047 a UXA-087
status: active
version: 1.3.0
...
# Índice das Frentes UXA-047 a UXA-087

## 1. Finalidade

Este índice mantém a descobribilidade da sequência integrada entre UXA-047 e UXA-087 sem recompilar, reinterpretar ou promover seus documentos além das decisões registradas em cada frente.

A autoridade de cada frente permanece no respectivo artefato. O estado transversal proposto por este incremento é `GKR-STATE-001` 2.13.0 e M7.74 quando o pacote for integrado.
...
## 3. Coletivos: contratos, materializações e validações
...
- [UXA-086 — Materialização da Visão Geral do Responsável do Coletivo](uxa-086-collective-responsible-overview-low-fidelity-wireframe.md)
- [UXA-087 — Validação funcional e reformulação da Visão Geral do Responsável](uxa-087-collective-responsible-overview-functional-validation-and-reformulation.md)
...
- [UXA-073 — Reformulação, navegação e sincronização](uxa-073-integrated-journeys-reformulation-navigation-and-synchronization.md)
- [UXA-074 — Revalidação funcional das jornadas integradas](uxa-074-integrated-journeys-functional-revalidation.md)
- [UXA-075 — Promoção controlada e sincronização pós-validação](uxa-075-integrated-journeys-controlled-promotion-and-post-validation-synchronization.md)
- [UXA-076 — Registros granulares de superfícies e transições](uxa-076-integrated-journeys-granular-transition-and-surface-registry.md)
- [UXA-077 — Validação funcional dos registros granulares](uxa-077-granular-registry-functional-validation.md)
- [UXA-078 — Reformulação controlada dos registros granulares](uxa-078-controlled-granular-registry-reformulation.md)
...
- [UXA-085 — Promoção controlada da galeria visual integrada](uxa-085-controlled-integrated-gallery-promotion-and-post-revalidation-synchronization.md)

## 7. Estado sincronizado

| Elemento | Estado |
|---|---|
| intervalo indexado | UXA-047 a UXA-087 |
| Registro do Estado Atual | 2.13.0 |
| marco | M7.74 |
| última frente integrada após merge | UXA-087 |
| SVGs | 98 |
...
| próxima frente | UXA-088, não iniciada |
| Engenharia de Produto | pausada antes de W0-01 |

## 8. Limite

Este índice registra a validação funcional de `GKR-SURF-COL-002`, mas não materializa `GKR-SURF-COL-003`, não valida `GKR-TRN-112` ponta a ponta, não fecha a jornada do Coletivo e não inicia UXA-088 ou Engenharia de Produto.
