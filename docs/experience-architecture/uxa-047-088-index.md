---
id: GKR-UXA-047-088-INDEX-001
title: Índice das Frentes UXA-047 a UXA-088
status: active
version: 1.4.0
...
# Índice das Frentes UXA-047 a UXA-088

## 1. Finalidade

Este índice mantém a descobribilidade da sequência integrada entre UXA-047 e UXA-088 sem promover seus documentos além das decisões registradas em cada frente.
...
| Elemento | Estado proposto pela UXA-088 |
|---|---|
| intervalo indexado | UXA-047 a UXA-088 |
| Registro do Estado Atual | 2.14.0 |
| marco | M7.75 |
...
| próxima frente | UXA-089, não iniciada |
| Engenharia de Produto | pausada antes de W0-01 |

## 6. Limite

Este índice registra a materialização de `GKR-SURF-COL-003`, mas não valida funcionalmente seus sete estados, não valida os handoffs bilaterais, não fecha a Jornada do Coletivo e não inicia UXA-089 ou Engenharia de Produto.
