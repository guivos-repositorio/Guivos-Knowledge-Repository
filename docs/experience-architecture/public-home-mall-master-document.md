...
### REAL_DATA_REQUIRED — Mall

Exige fonte/lastro antes de parecer factual: **produto, preço, preço em pontos, estoque, desconto, avaliação, marca/parceiro, elegibilidade, disponibilidade e campanha apresentados como reais**.
...
### PROHIBITED_INFERENCE — Mall

Não inferir nem comunicar como verdade: **estoque/preço inventados; marca tratada como parceira sem prova; recomendação personalizada sem base; pontos confundidos com Gift Card; mídia paga mascarada como relevância orgânica**.
