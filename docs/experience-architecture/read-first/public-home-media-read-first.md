...
# 00 — Leia Primeiro — Home Pública — Guivos Media

## 1. Função

Este arquivo é **camada de roteamento**, não nova autoridade de produto ou Design. Ele indica por onde começar para criar a Home Guivos Media sem reconstruir histórico, snapshots, checkpoints, PRs ou explorações antigas.
