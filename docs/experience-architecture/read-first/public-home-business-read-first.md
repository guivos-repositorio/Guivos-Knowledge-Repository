...
# 00 — Leia Primeiro — Home Pública — Guivos Business

## 1. Função

Este arquivo é **camada de roteamento**, não nova autoridade de produto ou Design. Ele indica por onde começar para criar a Home Guivos Business sem reconstruir histórico, snapshots, checkpoints, PRs ou explorações antigas.
...
1. `GKR-UX-HOME-BUSINESS-SOURCELOCK-001 v1.1.22` — `docs/experience-architecture/public-home-business-source-lock.md`;
...
4. `GKR-UX-HOME-BUSINESS-AUTHORITY-001 v1.0.7` — `docs/experience-architecture/public-home-business-authority-contracts.md`;
