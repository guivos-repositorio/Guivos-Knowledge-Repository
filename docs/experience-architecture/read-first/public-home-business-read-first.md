...
1. `GKR-UX-HOME-BUSINESS-SOURCELOCK-001 v1.1.13` — `docs/experience-architecture/public-home-business-source-lock.md`;
...
5. `GPA-004 v1.7.3` — `docs/product-architecture/business.md`;
