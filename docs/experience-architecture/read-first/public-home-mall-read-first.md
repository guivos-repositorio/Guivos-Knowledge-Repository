...
# 00 — Leia Primeiro — Home Pública — Guivos Mall

## 1. Função

Este arquivo é **camada de roteamento**, não nova autoridade de produto ou Design. Ele indica por onde começar para criar a Home Guivos Mall sem reconstruir histórico, snapshots, checkpoints, PRs ou explorações antigas.
...
2. `GKR-UX-HOME-MALL-MEDIA-SUPPLY-001 v1.0.0` — `docs/experience-architecture/public-home-mall-media-editorial-supply-reconciliation.md`;
