...
# 00 — Leia Primeiro — Home Pública — Pessoa

## 1. Função

Este arquivo é **camada de roteamento**, não nova autoridade de produto ou Design. Ele indica por onde começar para criar a Home Pessoa sem reconstruir histórico, snapshots, checkpoints, PRs ou explorações antigas.
...
2. `GKR-UX-HOME-PERSON-MEDIA-SUPPLY-001 v1.0.1` — `docs/experience-architecture/public-home-person-media-editorial-supply-reconciliation.md`;
