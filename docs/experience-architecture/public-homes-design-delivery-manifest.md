...
1. `GKR-UX-HOMES-DESIGN-HANDOFF-001 v1.7.6` — `docs/experience-architecture/public-homes-design-handoff.md`;
2. `GKR-UX-HOMES-DESIGN-PRODUCTION-READINESS-001 v1.3.13` — `docs/experience-architecture/public-homes-design-production-readiness-and-figma-contract.md`;
...
- `GKR-UX-HOME-BUSINESS-READ-FIRST-001 v1.0.4` — `docs/experience-architecture/read-first/public-home-business-read-first.md`;

- `GKR-UX-HOME-BUSINESS-SOURCELOCK-001 v1.1.16` — `docs/experience-architecture/public-home-business-source-lock.md`;
