...
1. `GKR-UX-HOMES-DESIGN-HANDOFF-001 v1.7.7` — `docs/experience-architecture/public-homes-design-handoff.md`;
2. `GKR-UX-HOMES-DESIGN-PRODUCTION-READINESS-001 v1.3.14` — `docs/experience-architecture/public-homes-design-production-readiness-and-figma-contract.md`;
...
- `GKR-UX-HOME-MEDIA-READ-FIRST-001 v1.0.0` — `docs/experience-architecture/read-first/public-home-media-read-first.md`;
...
- `GKR-UX-HOME-ADS-READ-FIRST-001 v1.0.0` — `docs/experience-architecture/read-first/public-home-ads-read-first.md`;
...
- `GKR-UX-HOME-BUSINESS-READ-FIRST-001 v1.0.5` — `docs/experience-architecture/read-first/public-home-business-read-first.md`;

- `GKR-UX-HOME-BUSINESS-SOURCELOCK-001 v1.1.17` — `docs/experience-architecture/public-home-business-source-lock.md`;
