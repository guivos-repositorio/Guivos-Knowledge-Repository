...
### REAL_DATA_REQUIRED — Media

Exige fonte/lastro antes de parecer factual: **conteúdo, autor, pessoa, história, imagem/vídeo com função factual, direitos, patrocínio, data e relação apresentados como reais**.
...
### PROHIBITED_INFERENCE — Media

Não inferir nem comunicar como verdade: **história fictícia como real; feed cronológico como identidade; conteúdo patrocinado sem identificação; formato transformado em arquitetura do produto**.
