---
id: GKR-UXA-047-096-INDEX-001
title: Índice das Frentes UXA-047 a UXA-096
status: active
version: 2.2.0
...
# Índice das Frentes UXA-047 a UXA-096
...
| Elemento | Estado proposto pela UXA-096 |
|---|---|
| intervalo indexado | UXA-047 a UXA-096 |
| Registro do Estado Atual | **2.22.0** |
| marco | **M7.83** |
| última frente proposta | **UXA-096** |
| SVGs | **108** |
...
Este índice registra a validação corrente de `PER-107`, `PER-108` e `TRN-111`. Não materializa estados P0B ou áreas P1, não promove jornadas, não inicia UXA-097 e não inicia Engenharia de Produto.
