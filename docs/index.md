...
PUBLIC HOMES CANONICAL SOURCE → CURRENT MAIN + GKR-UX-HOMES-DESIGN-DELIVERY-001 v7.0.3
PUBLIC HOMES DESIGN PRODUCTION READINESS → PASS / CURRENT / SNAPSHOT NOT REQUIRED
PUBLIC HOMES DESIGN PRODUCTION RELEASE → GRANTED / GKR-UX-HOMES-DESIGN-PRODUCTION-RELEASE-001 v1.3.0
