...
Ele preserva fundamentos, arquiteturas, modelos, decisões, pesquisas, validações e publicações públicas.
...
- A2-R02 — Fundamental Model Review ativa;
...
- Guia Oficial da Guivos na versão 3.3.0;
