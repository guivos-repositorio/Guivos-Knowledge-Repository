...
PUBLIC HOMES V5 SNAPSHOT → FROZEN / HISTORICAL / UNCHANGED
PUBLIC HOMES V6 MANIFEST → CANDIDATE / NOT_EMITTED
PUBLIC HOMES DESIGN PRODUCTION RELEASE → GRANTED / GKR-UX-HOMES-DESIGN-PRODUCTION-RELEASE-001 v1.1.0
PUBLIC HOMES NEW DESIGN HANDOFF → HOLD UNTIL V6 EMISSION
