...
GIA-COG-001
→ v0.1.2 / ACTIVE / NORMATIVE
→ CURRENT COGNITIVE REFERENCE ARCHITECTURE

PERSON JOURNEY DESIGN DOCUMENTATION
→ FLOW = GKR-UX-PERSON-JOURNEY-FLOW-001 v0.1.20
→ SURFACE MASTERS = 26 / 26 BUILT AFTER PUBLIC HOME
→ CURRENT MASTERS = PER-002 v0.1.0 + PER-003 v0.1.1 + PER-004 v0.1.0 + PER-005 v0.1.0 + PER-006 v0.1.0 + PER-007 v0.1.0 + PER-008 v0.1.0 + PER-010 v0.1.0 + PER-011 v0.1.0 + PER-012 v0.1.0 + PER-201 v0.1.0 + PER-202 v0.1.0 + PER-203 v0.1.1 + PER-101 v0.1.1 + PER-102 v0.1.1 + PER-103 v0.1.0 + PER-104 v0.1.0 + PER-105 v0.1.0 + PER-106 v0.1.0 + PER-107 v0.1.0 + PER-108 v0.1.0 + PER-009 v0.1.0 + PER-301 v0.1.0 + PER-302 v0.1.0 + PER-303 v0.1.0 + PER-304 v0.1.0
→ PER-003 CHOICES = TEXT / VOICE / FILE / OPTIONAL GUIDED QUESTIONS
→ PER-004 = TEXT / VOICE EXPRESSION + REVIEW
→ PER-005 = INVENTORY + REVIEW + SPECIFIC AUTHORIZATION
→ PER-006 = VISIBLE + TEMPORARY + INTERRUPTIBLE PROCESSING
→ PER-007 = REVISABLE INITIAL UNDERSTANDING + INDEPENDENT PERSISTENCE / PERSONALIZATION DECISIONS
→ PER-008 = TODAY / FIRST ENTRY + RECURRING SYNTHESIS
→ PER-010 = OBJECTIVES / UNDERSTAND + ORGANIZE + REVIEW + CONTROL
→ PER-011 = NEXT STEPS / UNDERSTAND + ORGANIZE + REVIEW + CONTROL
→ PER-012 = EVOLUTION / UNDERSTAND + REVIEW + CONTROL TRAJECTORIES
→ PER-201 = OPPORTUNITY MAP / TERRITORIAL DISCOVERY + QUERY CONTROL
→ PER-202 = OPPORTUNITY LIST / TEXTUAL TERRITORIAL DISCOVERY + ORDERING
→ PER-203 = OPPORTUNITY DETAIL / CONDITIONS + CONSCIOUS EXTERNAL HANDOFF
→ PER-101 = COLLECTIVE DISCOVERY / SEARCH + EXPLORATION
→ PER-102 = COLLECTIVE SEARCH RESULTS + REFINEMENT
→ PER-103 = COLLECTIVE PUBLIC PROFILE + CONSCIOUS REVIEW BEFORE LINK
→ PER-104 = CONSCIOUS REVIEW + AUTHORIZED REQUEST / ENTRY CONFIRMATION
→ PER-105 = REQUEST TRACKING + RESPONSE + CANCELLATION + RESULT
→ PER-106 = COLLECTIVE LINKS + STATE + ROLE + OPTIONAL UPDATES ENTRY
→ PER-107 = UPDATES TRIAGE + COMPREHENSION + REVALIDATED ACTION
→ PER-009 = ACCOUNT / SETTINGS GOVERNED ADMINISTRATIVE SLICE + VOLUNTARY PLANS ENTRY / RETURN
→ PER-301 = FREE / PLUS / PRO COMPARISON + VOLUNTARY PLAN DECISION
→ PER-302 = CONSCIOUS CONTRACT REVIEW + AFFIRMATIVE CONTINUATION
→ PER-303 = DOWNGRADE / CANCELLATION REVIEW + EXPLICIT CONSEQUENCES
→ PER-304 = RESULT / RECOVERY OF PLAN / BILLING
→ COLLECTION = 26 / 26 COMPLETE
...
→ HIGH-FIDELITY EXECUTION RELEASE = ISSUED / DELIVERY NOT_RECEIVED
→ INTERACTIVE PROTOTYPE = NOT_AUTHORIZED

PUBLIC HOMES
→ CANONICAL SOURCE = CURRENT MAIN + GKR-UX-HOMES-DESIGN-DELIVERY-001 v7.0.50
→ DESIGN PRODUCTION READINESS = GKR-UX-HOMES-DESIGN-PRODUCTION-READINESS-001 v1.3.30 / PASS
→ DESIGN PRODUCTION RELEASE = GRANTED / v1.3.4
...
- [PER-002 — Boundary Funcional Corrente](experience-architecture/per-002-materialization-eligibility-and-design-handoff-boundary.md)
- [PER-002 — Protótipo Interativo Corrente](experience-architecture/per-002-interactive-prototype-delivery.md)
- [PER-002 — Validação Corrente do Protótipo](experience-architecture/per-002-interactive-prototype-post-review-revalidation.md)
...
- [O/C — Autorização de Design High-Fidelity](experience-architecture/organizations-collectives-authenticated-high-fidelity-authorization.md)
