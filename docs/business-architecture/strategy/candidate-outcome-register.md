...
COEM: in progress — 6 of 18 candidates; 2 of 6 clusters
...
| COEM realizada | In progress — 6/18 candidatos e 2/6 clusters |
| Outcomes canônicos definidos | Not started |

## 12. Próximo passo governado

Submeter as seis disposições cumulativas dos clusters agência e evolução e confiança à revisão humana e, mediante aprovação separada, continuar a [Candidate Outcome Evaluation Matrix](candidate-outcome-evaluation-matrix.md) pelo próximo cluster governado. Os seis lotes permanecem evidência preparatória; nenhuma disposição altera o COR antes de decisão governada.
