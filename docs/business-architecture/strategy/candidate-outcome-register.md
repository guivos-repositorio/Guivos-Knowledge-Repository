...
| confiança | ECO-CAND-006, 008 e BUS-CAND-004 | ECO-CAND-006 reformulado por `COD-006`; nova COEM pendente |
...
1. decisão humana individual para as doze disposições restantes;
