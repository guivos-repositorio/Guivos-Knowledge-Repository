...
- [BA-STR-002 — Business Outcomes](strategy/business-outcomes.md) — checkpoint 0.19.0; COEM concluída; catálogo canônico pendente.
- [BA-STR-002-COR-001 — Candidate Outcome Register](strategy/candidate-outcome-register.md) — 18 candidatos em `Under Validation`; dezoito disposições pendentes de decisão.
...
3. `BA-STR-002` — Business Outcomes — **Draft 0.19.0; COEM concluída**
