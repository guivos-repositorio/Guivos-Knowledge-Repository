...
- [BA-STR-002 — Business Outcomes](strategy/business-outcomes.md) — checkpoint 0.15.0; COEM em execução; catálogo canônico pendente.
- [BA-STR-002-COR-001 — Candidate Outcome Register](strategy/candidate-outcome-register.md) — 18 candidatos em `Under Validation`; seis disposições pendentes de decisão.
...
- [BA-STR-002-COEM-001 — Candidate Outcome Evaluation Matrix](strategy/candidate-outcome-evaluation-matrix.md) — 6 de 18 candidatos e 2 de 6 clusters avaliados.
...
3. `BA-STR-002` — Business Outcomes — **Draft 0.15.0; COEM em execução**
