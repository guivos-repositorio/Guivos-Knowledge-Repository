...
`GKR-UX-D5-C1-001` governa o contrato funcional corrente de `PER-010..012`. `GKR-UX-GKR-UX-D5-C4B-001-001` registra a validação integrada corrente de `TRN-008..013`.
