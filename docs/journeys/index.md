...
|---|---|---|
| visão geral das Jornadas Integradas | `active` 0.36.0 | D4 + D5-C2 |
...
## 6. D5-C1/C2 — direção, movimento e evolução na Jornada da Pessoa
...
A D5-C2 acrescenta um estado-base low-fidelity para cada responsabilidade:
...
- `PER-010..012`: materializados em low-fidelity, ainda com validação funcional pendente;
...
- `PER-010..012` materializados não equivalem a superfícies funcionalmente validadas ou implementadas;
...
V1, V2, V3 e V4 estão encerradas nos limites declarados. D4 propaga `JED-001..JED-009`; D5-A e D5-B materializam o eixo em superfícies existentes; D5-C1 contrata `PER-010..012` e `TRN-008..013`; D5-C2 materializa as três superfícies em low-fidelity, mantendo três validações pendentes.

A validação/reformulação funcional dessas três superfícies e o exame ponta a ponta de `TRN-008..013` permanecem frente posterior separada. V5/UXA-102, D6, D7 e Engenharia de Produto permanecem fora desta frente.
