...
- `GKR-UX-PER006-MASTER-001` — Documento Mestre de `PER-006 — Processamento Visível`.
- `GKR-UX-PER007-MASTER-001` — Documento Mestre de `PER-007 — Compreensão Inicial Revisável`.
- `GKR-UX-PER008-MASTER-001` — Documento Mestre de `PER-008 — Hoje`.
- `GKR-UX-PER010-MASTER-001` — Documento Mestre de `PER-010 — Meus Objetivos`.
- `GKR-UX-PER011-MASTER-001` — Documento Mestre de `PER-011 — Meus Próximos Passos`.
- `GKR-UX-PER012-MASTER-001` — Documento Mestre de `PER-012 — Minha Evolução`.
- `GKR-UX-PER201-MASTER-001` — Documento Mestre de `PER-201 — Mapa de Oportunidades`.
...
- `GKR-UX-PER104-MASTER-001` — Documento Mestre de `PER-104 — Revisão e Solicitação`.
- `GKR-UX-PER105-MASTER-001` — Documento Mestre de `PER-105 — Solicitação Pendente`.
- `GKR-UX-PER106-MASTER-001` — Documento Mestre de `PER-106 — Meus Coletivos`.
- `GKR-UX-PER107-MASTER-001` — Documento Mestre de `PER-107 — Central de Atualizações`.
