...
| recebimento de solicitação | contratado | UXA-056 | perspectiva da Pessoa em UXA-066; operação responsável em UXA-088 | UXA-067 somente na perspectiva da Pessoa | parcial |
| visão do responsável | validado | UXA-059 | UXA-086 | UXA-087 | parcial |
| decisão do responsável | materializado; validação pendente | UXA-056; UXA-059 | UXA-088; 7 SVGs desktop | pendente | bilateral ainda não validada |
| formação ou recusa do vínculo | contratado | UXA-014; UXA-056 | resultados na Pessoa em UXA-066 e origem da decisão em UXA-088 | UXA-067 somente na perspectiva da Pessoa | parcial |

A UXA-088 reduz a assimetria visual, mas não converte o conjunto em jornada validada.
...
| gestão de solicitações | materializado; validação pendente | UXA-056; UXA-059 | UXA-088; 7 SVGs desktop | UXA-067 somente para efeitos na Pessoa; responsável pendente | parcial |
...
|---|---|---|---|---|
| Visão Geral do Responsável | gestão de solicitações | UXA-086; UXA-087 | UXA-088 | ambos endpoints materializados; `GKR-TRN-112` ainda não validada ponta a ponta |
| Pessoa solicitante | responsável do Coletivo | UXA-066; UXA-067 | UXA-088 | evidência bilateral materializada; validação integrada pendente |
| responsável do Coletivo | Pessoa solicitante | UXA-088 | UXA-066; UXA-067 | efeitos dos pedidos adicionais e resultados existem nos dois lados; validação integrada pendente |
| aprovação | Meus Coletivos | UXA-088 e resultado na Pessoa | `GKR-SURF-PER-106` ausente | parcial e bloqueada após decisão |
...
- os sete SVGs da gestão de solicitações ainda não possuem validação funcional específica;
...
A próxima frente autorizável é **UXA-089 — Validação Funcional da Gestão de Solicitações do Responsável do Coletivo**.

A UXA-089 não é iniciada pela UXA-088 e depende de autorização separada.
