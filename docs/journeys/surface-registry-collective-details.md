...
A cadeia autenticada corrente de Coletivo está definida por Jobs/autoridade, Arquitetura da Informação, Surface Map, State Map, Priority Flows, Navigation Materialization e pelo pacote low-fidelity entregue e validado. `GKR-UX-ORGCOL-AUTH-HIFI-AUTH-001 v1.0.2` autoriza o Design high-fidelity e `GKR-UX-ORGCOL-AUTH-HIFI-EXEC-001 v1.0.0` libera sua execução externa; a entrega permanece `NOT_RECEIVED`. Protótipo interativo e Product Engineering permanecem não liberados.
...
| GKR-SURF-COL-004 | GKR-UX-ORGCOL-AUTH-SURFACE-MAP-001 + GKR-UX-ORGCOL-AUTH-STATE-MAP-001 | contratada; cobertura low-fidelity parcial em Participação; validação dedicada ponta a ponta não comprovada | vínculo formado ou participação aplicável | compreender/gerir vínculo dentro da autoridade | gestão, saída ou contestação | estado do vínculo e dados mínimos aplicáveis | representação e autoridade | retorno/saída conforme regra | sem autoridade visual corrente própria | Participação = PASS no pacote low-fidelity; continuidade dedicada não examinada ponta a ponta | materialização dedicada e continuidade interna permanecem abertas | contrato corrente existe; cobertura parcial não equivale a superfície dedicada integralmente validada |
| GKR-SURF-COL-005 | UXA-058 + GKR-UX-ORGCOL-AUTH-SURFACE-MAP-001 + GKR-UX-ORGCOL-AUTH-STATE-MAP-001 | contratada; cobertura low-fidelity parcial em Participação/Governança; validação dedicada ponta a ponta não comprovada | vínculo e autoridade | comunicar dentro da finalidade legítima | atualização aos participantes autorizados | audiência, finalidade e conteúdo permitido | papel, audiência e finalidade | retorno/revisão conforme contrato | sem autoridade visual corrente própria | Participação + Governança e Proteção = PASS no pacote low-fidelity; continuidade dedicada não examinada ponta a ponta | materialização dedicada e regras operacionais completas permanecem abertas | comunicação oficial não implica mensagem privada irrestrita |
| GKR-SURF-COL-006 | GKR-UX-ORGCOL-AUTH-SURFACE-MAP-001 + GKR-UX-ORGCOL-AUTH-STATE-MAP-001 | contratada; cobertura low-fidelity parcial em Atividades/Governança; validação dedicada ponta a ponta não comprovada | governança interna ou atividade aplicável | operar atividade/consulta/decisão dentro de autoridade | resultados e próximas decisões | estado, atividade, decisão e contexto permitido | autoridade contextual | interromper/retornar conforme regra | sem autoridade visual corrente própria | Atividades e Oportunidades + Governança e Proteção = PASS no pacote low-fidelity; continuidade dedicada não examinada ponta a ponta | materialização dedicada e matriz operacional integrada permanecem abertas | atividade não equivale automaticamente a resultado ou impacto |
| GKR-SURF-COL-007 | UXA-058 + GKR-UX-ORGCOL-AUTH-SURFACE-MAP-001 + GKR-UX-ORGCOL-AUTH-STATE-MAP-001 | contratada; cobertura low-fidelity parcial em C-A/X2; validação dedicada ponta a ponta não comprovada | condição de proteção/moderação aplicável | avaliar e atuar em proteção/moderação dentro da autoridade proporcional | proteção, moderação ou encaminhamento compatível com o estado | evidências mínimas, relato, estado e encaminhamento no limite autorizado | autoridade de proteção/moderação; finalidade limitada; proporcionalidade | contestar, corrigir, revisar ou encaminhar conforme contrato | sem autoridade visual corrente própria | Governança e Proteção = PASS no pacote low-fidelity; continuidade dedicada não examinada ponta a ponta | materialização dedicada e handoffs específicos permanecem abertos | proteção/moderação não equivale a punição automática nem amplia autoridade sobre participantes |
| GKR-SURF-COL-008 | UXA-019 + GKR-UX-ORGCOL-AUTH-SURFACE-MAP-001 + GKR-UX-ORGCOL-AUTH-STATE-MAP-001 | contratada; lifecycle O↔C definido; cobertura low-fidelity parcial; validação dedicada ponta a ponta não comprovada | proposta ou relação O↔C vigente conforme estado | avaliar, negociar, aceitar, revisar, pausar ou encerrar dentro da autoridade bilateral | continuidade bilateral conforme lifecycle corrente | finalidade, compromissos, recursos, limites, dados e versão materialmente relevante | autoridade do responsável e aprovação bilateral quando aplicável | recusar, ajustar, pausar, contestar ou encerrar conforme contrato | sem autoridade visual corrente própria | Relações O↔C = PASS no pacote low-fidelity; TRN-206..209 preservam maturidade contratada | materialização dedicada e continuidade ponta a ponta permanecem abertas | escopo exclusivo Organização–Coletivo; não abrange Coletivo–Coletivo por analogia |
