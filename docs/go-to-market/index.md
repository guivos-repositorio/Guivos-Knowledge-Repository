...
- `GEM-004-PLAN-TAXONOMY-AUTHORITY-001` para a taxonomia global dos planos;
...
| ID | Documento | Função |
|---|---|---|
| `GTM-001` | [Sequenciamento de Lançamento e Expansão Geográfica](gtm-001-launch-and-geographic-sequencing.md) | BH → SP → Brasil → Portugal, com gates |
| `GTM-002` | [Motor Comercial, Captação e Parcerias](gtm-002-commercial-acquisition-and-partnership-engine.md) | metas de vendas, aquisição, organizações, Business e alianças estratégicas |
