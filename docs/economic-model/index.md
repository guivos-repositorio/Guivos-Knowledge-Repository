...
- [Fundação do Guivos Economic Model](gem-001-foundation.md);
...
- [Incentivos e Recompensas](gem-005-incentives-and-rewards-model.md);
- [Arquitetura das Camadas de Incentivo](gem-005-incentive-layer-architecture.md);
- [Catálogo de Famílias de Incentivo](gem-005-incentive-family-catalog.md);
- [Política Conceitual de Pontos e Créditos](gem-005-points-and-credits-policy.md);
- [Modelo de Financiamento de Recompensas](gem-005-reward-funding-model.md);
- [Eventos Elegíveis e Evidências](gem-005-eligible-events-and-evidence.md);
- [Ciclo de Vida de Recompensas](gem-005-reward-lifecycle.md);
- [Política de Resgate, Expiração e Reversão](gem-005-redemption-expiration-reversal-policy.md);
- [Política de Segurança Comportamental](gem-005-behavioral-safety-policy.md);
