...
3. assinatura da plataforma é diferente do preço de uma atividade, oportunidade, produto ou serviço;
...
| Jornada essencial e compreensão inicial | incluídas | incluídas | incluídas |
| Tela Hoje | geral ou básica | personalizada | personalizada e ampliada |
...
| Exportação | registros essenciais | exportação padrão | relatórios e exportações ampliadas |
...
| Núcleos ou unidades | 1 | 1 | até 5 | múltiplos, conforme contrato |
| Indicadores | básicos, 30 dias | ampliados | avançados e históricos | personalizados |
| Pagamentos e inscrições pagas | não | incluídos | incluídos | incluídos e integráveis |
