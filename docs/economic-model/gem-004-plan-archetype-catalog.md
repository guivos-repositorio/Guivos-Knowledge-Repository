...
| Código | Arquétipo | Financiamento possível | Beneficiário principal | Finalidade |
|---|---|---|---|---|
| AM-01 | Participante Universal | gratuito | participante | participação e valor básico |
| AM-02 | Participante Ampliado | individual, financiado ou híbrido | participante | profundidade, capacidade e personalização |
| AM-03 | Participante Assistido | individual, organizacional ou patrocinado | participante | suporte humano e serviço especializado |
