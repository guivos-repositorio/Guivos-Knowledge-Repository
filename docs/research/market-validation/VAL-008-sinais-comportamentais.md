...
Comportamentos espontâneos podem revelar compreensão, curiosidade, dúvida ou intenção real. Devem ser registrados de forma descritiva, sem inferências psicológicas indevidas.

## 3. Sinais durante a apresentação
...
## 4. Sinais durante as perguntas

- responde rapidamente ou precisa de muito tempo;
- pede esclarecimentos;
- muda de resposta após compreender melhor;
...
A classificação deverá ser acompanhada por uma observação objetiva.
