...
Evitar que a Guivos seja validada apenas por pessoas próximas, perfis semelhantes ou públicos naturalmente mais favoráveis à proposta.

## 2. Fases da amostra

### Pré-teste

10 a 15 pessoas com perfis diversos.

### Entrevistas qualitativas

20 a 30 entrevistas iniciais, ampliadas até saturação dos padrões.

### Pesquisa quantitativa inicial

Mínimo de 200 respostas válidas.

### Pesquisa ampliada

Meta de 500 respostas antes de decisões de posicionamento mais abrangentes.

## 3. Quotas mínimas de diversidade

Buscar distribuição entre:
