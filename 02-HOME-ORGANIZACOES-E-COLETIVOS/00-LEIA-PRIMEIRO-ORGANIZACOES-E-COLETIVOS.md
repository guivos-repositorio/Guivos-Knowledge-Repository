...
Este diretório contém o contexto isolado de trabalho para a primeira rodada de Design da **Home Pública — Organizações e Coletivos**.
...
Não adicione documentos específicos de Pessoa, Mall, Travel ou Media à mesma execução generativa.
