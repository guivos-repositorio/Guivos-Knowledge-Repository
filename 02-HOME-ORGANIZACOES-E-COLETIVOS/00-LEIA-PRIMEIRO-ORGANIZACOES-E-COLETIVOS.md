# LEIA PRIMEIRO — Home Pública — Organizações e Coletivos

Este diretório contém o contexto isolado de trabalho para a primeira rodada de Design da **Home Pública — Organizações e Coletivos** na emissão v2.
...
Não adicione documentos específicos de Pessoa, Mall, Travel, Media ou Ads à mesma execução generativa.
