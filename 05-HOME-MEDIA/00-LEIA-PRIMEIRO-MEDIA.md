# LEIA PRIMEIRO — Guivos Media — Emissão v5
...
5. `01-Documento-Mestre.md` — GKR-UX-HOME-MEDIA-MASTER-001 v1.0.0
6. `02-GPA-005-Guivos-Media.md` — GPA-005 v1.2.0
...
- `01-Documento-Mestre.md` — `GKR-UX-HOME-MEDIA-MASTER-001 v1.0.0` — blob `8bee2c5e5793ed63b927672eea8a1dd1502ebb3d`
- `02-GPA-005-Guivos-Media.md` — `GPA-005 v1.2.0` — blob `59ddb05ffc9b3d6d6e6f27fc405f82e4bc6ee260`
...
Você está trabalhando **exclusivamente na Home Guivos Media da Guivos**, usando o snapshot v5 congelado acima.
