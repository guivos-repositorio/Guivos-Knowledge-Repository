...
UXA_INDEX_PATH = ROOT / "docs/experience-architecture/uxa-047-087-index.md"
...
EXPECTED_UXA_FILES = [
    ...
    "uxa-087-collective-responsible-overview-functional-validation-and-reformulation.md",
]
